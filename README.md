# AfriDataHub - Igbo Language Dataset Repository

Welcome to the AfriDataHub Igbo repository! This repository is dedicated to building high-quality language datasets and natural language processing (NLP) tools for the Igbo language, as part of AfriDataHub’s mission to enhance digital inclusion for African languages. Our goal is to create resources that enable culturally relevant AI applications in Igbo.
...
- Building parallel corpora for machine translation between Igbo and English.
...
- `models/`: Pre-trained NLP models for Igbo, such as machine translation and language models.
...
To get started with using the datasets and models for Igbo, please refer to our [Usage Guide](docs/usage.md) for detailed instructions on accessing and utilizing these resources.
...
3. Sharing knowledge on Igbo grammar, syntax, and vocabulary.
